...
public class MagnifierWindow extends JFrame {
	...
	public MagnifierWindow(String windowTitle) {
		...
		menu100Pixels.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				magnifierSize = 100;
				updateSize(magnifierSize);
			}
		});
		menu200Pixels.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				magnifierSize = 200;
				updateSize(magnifierSize);
			}
		...
		menuHow.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				jTextArea
						.setText("1.Single click on left mouse button stops magnifier movement.\n"
				...
				jOptionPane
						.showMessageDialog(null, jTextArea,
		...
		menuAbout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Magnifier v1.14", "About",
						JOptionPane.INFORMATION_MESSAGE);
			}
		});
		...
		public void run() {
			while (true) {
				if (magnifierStopped == false) {
					...
					if (setCoordinateX < 0)
						onScreenMoveDidectionX = onScreenMoveDidectionUp;
					if (setCoordinateY < 0)
						onScreenMoveDidectionY = onScreenMoveDidectionUp;
					if (setCoordinateX > (screenWidth - magnifierSize))
						onScreenMoveDidectionX = onScreenMoveDidectionDown;
					if (setCoordinateY > (screenHeight - magnifierSize))
						onScreenMoveDidectionY = onScreenMoveDidectionDown;
	...
	private class MouseMotionFunctions extends MouseMotionAdapter {
		public void mouseDragged(MouseEvent e) {
			if (mousePressedNow == true) {
				absoluteCoordinateX = MagnifierWindow.this
						.getLocationOnScreen().x + e.getX();
				absoluteCoordinateY = MagnifierWindow.this
